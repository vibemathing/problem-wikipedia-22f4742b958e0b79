...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-22f4742b958e0b79"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-22f4742b958e0b79",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-22f4742b958e0b79",
        "url": "https://en.wikipedia.org/wiki/Graph_toughness"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Chvátal's toughness conjecture , that there is a number t such that every t -tough graph is Hamiltonian",
      "version": 1
    },
    "title": "Chvátal's toughness conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "25db96a581b31a040f72a69e51472a5d3f54dd796abe371421a7df40caf2e580"
}
```
